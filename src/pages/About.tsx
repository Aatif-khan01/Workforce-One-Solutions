  ...
  const principles = [
    {
      ...
      description:
        "We regard you as a partner, your goals are our goals. We invest time to understand your mission, culture and outcomes.",
      icon: Heart,
    },
    {
      title: "Your Data & Info Are Secure",
      description:
        "We handle your information responsibly and implement strong controls to protect confidentiality.",
      icon: Shield,
    },
    {
      title: "Transparent Communication",
      description:
        "We keep you informed, respond promptly and work in the channels you prefer. No surprises, no hidden fees.",
      icon: Users,
    },
    {
      title: "Quality First",
      description:
        "We apply disciplined processes and continuous improvement to ensure our work meets and exceeds expectations.",
      icon: Award,
    },
  ];
        ...
        sections={[
          {
            ...
            content:
              "We operate with transparency, honesty, and ethical standards in all our interactions. Your trust is our most valuable asset, and we earn it through consistent, principled action.",
          },
          {
            title: "Client-Centric Focus",
            icon: <Heart size={24} className="text-background" />,
            content:
              "Your success is our success. We listen deeply, understand your unique challenges, and tailor solutions that align with your goals, culture, and mission.",
          },
          {
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <GlassCard className="p-8 sm:p-12 md:p-16 text-center">
            ...
            <Link to="/contact">
              <Button
                size="lg"
                className="bg-gradient-to-r from-coral to-secondary hover:shadow-glow text-base md:text-lg px-8 sm:px-12 py-5 md:py-6 group w-full sm:w-auto"
              >
                Get in Touch
