...
import Navigation from "@/components/Navigation";import { Link } from "react-router-dom";
import { ArrowRight, CheckCircle, Users, FileText, Code, Briefcase, Target, Zap, Shield } from "lucide-react";
          ...
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <AnimatedBox animation="fadeInUp" delay={50}>
              <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
                <Link to="/contact">
                  <Button size="lg" className="group bg-gradient-to-r from-[#45A3FF] to-[#3454FF] hover:shadow-lg text-white text-lg px-8 py-6">
                    Get Started
